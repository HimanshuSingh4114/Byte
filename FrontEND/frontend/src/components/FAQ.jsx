...
const FAQ = () => {
  return (
    <div>
  <Navbar />
  <div className="p-4 md:p-8 mt-4 md:mt-10 py-10">
    <div className="flex flex-wrap">
      <div className="w-full lg:w-1/2 lg:pr-8 py-10">
        <div className="bg-pink-50 p-4 md:p-8 rounded-lg mb-8">
          <h2 className="text-blue-900 text-2xl md:text-4xl font-bold mb-4">FREQUENTLY ASKED QUESTIONS</h2>
      ...
      <div className="w-full lg:w-1/2 lg:pl-8 py-10">
