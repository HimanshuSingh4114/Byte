...
export default function CreateListing() {
  ...
  const fetchProduct = async () => {
    ...
    try {
      const response = await fetch('http://bytebazaar-webscraping/scrape', {
        method: 'POST',
        headers: {
      ...
      setError('Error occurred while fetching product');
      console.log(err);
    }
  };
        ...
        <h2 className="text-2xl font-bold mb-6">Create Listing</h2>
         ...
         <div className="mb-6">
            ...
            <button
              ...
              className='w-full p-3 bg-blue-500 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'
            >
              Fetch and Fill Form
            </button>
        </div>
