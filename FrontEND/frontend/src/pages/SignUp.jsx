            ...
            <form autoComplete="off" onSubmit={handleSubmit}>
              ...
              <div className="space-y-4">
                <div className="flex items-center text-xl justify-center">
                  <p className="mr-2 text-black font-bold">Create Your New Account</p>
                </div>
                ...
                <div className="overflow-auto max-h-64">
                  ...
                  <div className="relative mb-4">
                    ...
                    <button
                      type="button"
                      className="absolute inset-y-0 right-3 flex items-center text-gray-700 mt-7"
                  ...
                  <div className="mb-4">
                    <label className="block mb-1 font-semibold text-gray-700">Account Type</label>
                    <select
                      name="userType"
                      className="w-full p-2 border border-gray-300 rounded-md"
                      onChange={handleChange}
                ...
                <div className="text-center flex items-center justify-center mt-1">
                  ...
                  <Link to="/sign-in" className="text-blue-700 cursor-pointer">Sign In</Link>
                </div>
              </div>
            </form>
